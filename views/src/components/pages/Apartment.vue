            ...
            <b-row align="center">
                <b-col cols="7">
                    <PicsAndPrice
                        ...
                        :buildingNum="apartment.location.address.number"
                        :entranceNum="apartment.location.address.apartmentNumber"
                            ...
                            <b-row>
                                ...
                                <b-col align="center" cols="8">
                                    ...
                                    <b-img src="data:image/png;base64,"
                                            style="width:30px;height:auto" rounded/> {{auther.email}}<br>                 
                                </b-col>
                            </b-row>   
                        </b-container>
                    </b-card>
...
<script>
    ...
    import InterestedUsers from '@/components/single-apartment/InterestedUsers';
    ...
    export default {
        ...
        components: {
            ...
            ApartmentTags, bLink, PicsAndPrice, InterestedUsers,
        ...
        methods:{
            setAuther(responseFromServer,pThis){
                pThis.auther = responseFromServer.body.user;
            }
        }
    }
</script>
