        ...
        <v-card>
            ...
            <v-card-actions>
              ...
              <v-dialog v-model="ToSDialog" fullscreen hide-overlay transition="dialog-bottom-transition">
                <v-btn slot="activator" color="primary" dark>Terms of Service</v-btn>
                <v-card>
                ...
                <v-spacer/>
              <v-dialog v-model="contractDialog" fullscreen hide-overlay transition="dialog-bottom-transition">
  ...
  export default {
    ...
    methods: {
      paymentSuccess(payment) {
        if (payment.state === 'approved' && this.agreedToS === true) {
          alert(`success!\nID: ${payment.id}`);
