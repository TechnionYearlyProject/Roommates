  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-4 offset-sm-1">
        ...
        <image-upload :isMultiple="true" :isReadOnly="isReadOnly" :images="info.images" @imagesSelected="saveImages" />
      </div>
      <div class="col-sm-6 mt-3">
        <div role="group">
          <label for="title">Title:</label>
          <b-form-text style="float:right" id="inputTitleHelp">Required. At least 4 letters.</b-form-text>
          <b-form-input
          id="title"
          type="text"
          placeholder=""
          v-model.trim.lazy="info.title"
          :readonly="isReadOnly"
        ...
        <div role="group">
          ...
          <b-form-input
           ...
           type="number"
           placeholder=""
           v-model.number.lazy="info.price"
           :readonly="isReadOnly" 
           required></b-form-input>
        ...
        <div role="group">
          ...
          <b-form-input
           ...
           v-model.trim.lazy="info.address.city"
           :readonly="isReadOnly"
           required></b-form-input>
          ...
          <div class="row mt-2">
            <div class="col-md-8">
                ...
                placeholder="Street"
                aria-labelledby='lblLocation'
                v-model.trim.lazy="info.address.street" 
                :readonly="isReadOnly"
                required></b-form-input>
            </div>
            <div class="col-md-4">
